        ...
        GeofenceListFragment.OnGeofenceSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton btn = (FloatingActionButton)findViewById(R.id.button_add_geofence);
        ...
        /*
        FloatingActionButton btn2 = (FloatingActionButton)findViewById(R.id.button_geoservice_start);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.geofence_list_menu, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.menu_geoservice_start:
                startService();
                return true;
            default:
    ...
    public void onConnected(Bundle bundle) {
        ...
        if (mLocation != null) {
            ...
            mMarker = mMap.addMarker(new MarkerOptions().position(sydney).title("Вы"));
            //mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(sydney, 9));
            //mMap.addPolygon(MapHelper.createPolygonWithCircle(this, sydney, 30));
